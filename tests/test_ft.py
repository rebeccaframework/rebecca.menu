...
def app():
    ...
    def index(request):
        ...
        return {
            "system_menu": [(m.display_name, m.url) for m in menu.menu_items]
        }
    ...
    class RootResource(object):
        ...
        __acl__ = [(Allow, 'testing-user', 'testing-permission'), ]
    ...
    config.add_route_menu(
        menu_name="system",
        route_name="menu1",
        display_name="system menu item1")
    config.add_route_menu(
        menu_name="system",
        route_name="menu2",
        display_name="system menu item2")
    config.add_route_menu(
        menu_name="system",
        route_name="menu3",
    ...
    config.add_route_menu(
        menu_name="system",
        route_name="menu4",
        display_name="system menu item4",
...
def test_no_permission(app):
    ...
    assert res.json == {
        'system_menu': [['system menu item1', 'http://localhost/menus/menu1'],
...
def test_with_permission(app):
    ...
    assert res.json == {
        'system_menu': [
            ['system menu item1', 'http://localhost/menus/menu1'],
            ['system menu item2', 'http://localhost/menus/menu2'],
